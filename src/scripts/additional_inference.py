...
global_params = torch.tensor([[-2.1, -3.0], [0.3, 0.3]])
...
# --- plot the data ---
gaussian_posterior_plot(alpha_IMF_obs, log10_N_Ia_obs, global_params.numpy(), title="different_prior")

stars = np.arange(1,1000)
n_stars_plot(alpha_IMF_obs, log10_N_Ia_obs, global_params.numpy(), "Nstar_comp_different_prior", stars)