...
For each individual observation consisting of the abundance measurements of a single star we sample the posterior estimate with 1000 points. %(see Fig.~\ref{fig:posterior_samples} in the appendix)
...
\begin{figure*}[]
     \centering
     \includegraphics[width=\columnwidth]{figures/sbc_rank_plot_NPE_C.pdf}
