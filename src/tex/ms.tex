...
\begin{figure*}
    \centering
    \includegraphics[width=\textwidth]{figures/corner_plot_singlestar.pdf}
    \vspace{-.5cm}
...
\begin{figure*}
    ...
    \vspace{-.5cm}
    \caption{Correlation analysis of the global parameters.}
